# Generated by Powerlevel10k configuration wizard on 2025-08-04 at 07:30 CST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 13396.
# Wizard options: powerline, classic, unicode, lightest, 12h time, angled separators,
...
() {
  ...
  # DX-P10K # typeset -g POWERLEVEL9K_VCS_BRANCH_ICON=
  ...
  # Custom icon.
  # DX-set-p10k # typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION='⭐'
  ...
  # DX-P10k # typeset -g POWERLEVEL9K_PYENV_CONTENT_EXPANSION='${P9K_CONTENT}${${P9K_CONTENT:#$P9K_PYENV_PYTHON_VERSION(|/*)}:+ $P9K_PYENV_PYTHON_VERSION}'
  typeset -g POWERLEVEL9K_PYENV_CONTENT_EXPANSION='${P9K_CONTENT}'

  # Custom icon.
  # DX-P10K # typeset -g POWERLEVEL9K_PYENV_VISUAL_IDENTIFIER_EXPANSION='⭐'
  ...
  # DX-P10k # typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M}'
