# Generated by Powerlevel10k configuration wizard on 2024-07-15 at 02:18 CST.
# Wizard options: nerdfont-v3(complete) + powerline, large (small) icons, classic, unicode, lightest,
# 12h (24h) time, angled separators, sharp heads, flat (round) tails, 1 line, compact, many icons,
